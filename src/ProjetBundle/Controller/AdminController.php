...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $admins = $em->getRepository('ProjetBundle:Admin')->findAll();
    ...
    {
        $admin = new Admin();
        $form = $this->createForm('ProjetBundle\Form\AdminType', $admin);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_show', array('idAdmin' => $admin->getIdadmin()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($admin);
        $editForm = $this->createForm('ProjetBundle\Form\AdminType', $admin);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('admin_edit', array('idAdmin' => $admin->getIdadmin()));
        }
    ...
    private function createDeleteForm(Admin $admin)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_delete', array('idAdmin' => $admin->getIdadmin())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
