...
use ProjetBundle\Entity\Etudiant;
...
class EtudiantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $etudiants = $em->getRepository('ProjetBundle:Etudiant')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ProjetBundle\Form\EtudiantType', $etudiant);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('etudiant_show', array('idEtudiant' => $etudiant->getIdetudiant()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($etudiant);
        $editForm = $this->createForm('ProjetBundle\Form\EtudiantType', $etudiant);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('etudiant_edit', array('idEtudiant' => $etudiant->getIdetudiant()));
        }
    ...
    private function createDeleteForm(Etudiant $etudiant)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('etudiant_delete', array('idEtudiant' => $etudiant->getIdetudiant())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
