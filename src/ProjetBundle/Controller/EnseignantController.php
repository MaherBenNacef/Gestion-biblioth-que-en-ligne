...
class EnseignantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $enseignants = $em->getRepository('ProjetBundle:Enseignant')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ProjetBundle\Form\EnseignantType', $enseignant);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('enseignant_show', array('idEnseignant' => $enseignant->getIdenseignant()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($enseignant);
        $editForm = $this->createForm('ProjetBundle\Form\EnseignantType', $enseignant);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('enseignant_edit', array('idEnseignant' => $enseignant->getIdenseignant()));
        }
    ...
    private function createDeleteForm(Enseignant $enseignant)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('enseignant_delete', array('idEnseignant' => $enseignant->getIdenseignant())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
