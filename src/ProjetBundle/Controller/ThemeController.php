...
class ThemeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $themes = $em->getRepository('ProjetBundle:Theme')->findAll();
    ...
    {
        $theme = new Theme();
        $form = $this->createForm('ProjetBundle\Form\ThemeType', $theme);
        ...
        if ($form->isSubmitted()) {
            ...
            return $this->redirectToRoute('theme_show', array('idTheme' => $theme->getIdTheme()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($theme);
        $editForm = $this->createForm('ProjetBundle\Form\ThemeType', $theme);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('theme_edit', array('idTheme' => $theme->getIdTheme()));
        }
    ...
    private function createDeleteForm(Theme $theme)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('theme_delete', array('idTheme' => $theme->getIdTheme())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
